...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 z-50 bg-[#f5f5f5] hidden lg:block ring-1 ring-gray-300 shadow-inner w-[70px] h-screen">
        <nav className="flex flex-col items-center justify-center gap-6 py-5 h-full">
          ...
          >
            <SparklesIcon className="w-9 h-9 fill-lime-800 stroke-0" />
          </Link>
          <div className="space-y-3">
            {navigation.slice(0, 5).map((item, index) => (
              <Link
                key={index}
                href={item.href}
                className="group relative w-11 h-11 mx-auto bg-lime-50 hover:bg-lime-100 ring-1 ring-lime-200 hover:ring-lime-500 shadow-inner transition duration-300 ease-in-out rounded-xl flex items-center justify-center"
              >
                <item.icon className="w-6 h-6 stroke-lime-800" />
          ...
          <div className="flex flex-col items-center justify-end items-end h-full space-y-3">
            {navigation.slice(5, navigation.length).map((item, index) => (
              <Link
                key={index}
                href={item.href}
                className="group relative w-11 h-11 bg-lime-50 hover:bg-lime-100 ring-1 ring-lime-200 hover:ring-lime-500 shadow-inner transition duration-300 ease-in-out rounded-xl flex items-center justify-center"
              >
                <item.icon className="w-6 h-6 stroke-lime-800" />
                      ...
                      <nav className="flex flex-col items-center justify-center gap-6 py-5 h-full">
                        ...
                        <div className="space-y-3">
                          {navigation.slice(0, 5).map((item, index) => (
                            <div
                              key={index}
                              className="group relative w-11 h-11 mx-auto bg-lime-50 hover:bg-lime-200 ring-1 ring-lime-200 hover:ring-lime-400 shadow-inner transition duration-300 ease-in-out rounded-xl flex items-center justify-center"
                            >
                              <item.icon className="w-6 h-6 stroke-lime-800" />
                        ...
                        <div className="flex flex-col items-center justify-end items-end h-full space-y-3">
                          {navigation
                            ...
                            .map((item, index) => (
                              <div
                                key={index}
                                className="group relative w-11 h-11 bg-lime-50 hover:bg-lime-200 ring-1 ring-lime-200 hover:ring-lime-400 shadow-inner transition duration-300 ease-in-out rounded-xl flex items-center justify-center"
                              >
                                <item.icon className="w-6 h-6 stroke-lime-800" />
                                <div className="hidden group-hover:block absolute left-14 mb-12 bg-gray-50 ring-1 ring-gray-300 shadow-inner text-gray-700 px-2 py-1 rounded-lg">
                                  <p className="text-xs font-medium">
